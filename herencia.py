...
#herencia multiple, SIEMPRE se da prioridad a la primera clase ingresada por parametro.
#pueden ser más de dos clases.
#hay varios lenguajes POO que no soportan la herencia multiple.
class bicicletaElectrica(vehElectricos,vehiculos):
	pass

miBici=bicicletaElectrica("Orbea","H21")